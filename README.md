...
Also, for 768x768 sampling:
```commandline
python txt2img.py --ckpt <PATH-TO-HIGHRES-CHECKPOINT> --config configs/stable-diffusion/anime-inference-highres.yaml --seed=9831744  --plms --H 768 --W 768 --n_samples=1 --steps=50 --scale=8.0 --prompt="1girl, smile, rating_s, adjusted_score_perc_100, score_perc_100"
python img2img.py --ckpt <PATH-TO-HIGHRES-CHECKPOINT> --config configs/stable-diffusion/anime-inference-highres.yaml --n_samples=1 --scale=8.0 --prompt "1girl, solo, smile, rating_s, adjusted_score_perc_100, score_perc_100" --init-img assets/stable-samples/img2img/sketch-mountains-input.jpg --strength 0.8
```
